# -*- coding: utf-8 -*-
"""Benchmark eval2-with-context against others."""
...
AGENTS_CONFIG = [make_baseline, make_eval2, make_v3, make_mcts]
AGENT_NAMES = ['Baseline', 'Eval2Ctx', 'V3', 'MCTS']
