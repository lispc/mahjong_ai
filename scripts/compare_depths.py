# -*- coding: utf-8 -*-
"""Head-to-head: ExpectiMax depth=1 vs depth=2 (both new eval_v2)."""
...
def make_d1():
    return ExpectiMaxAgent('D1', depth=1, verbose=False)


def make_d2():
    return ExpectiMaxAgent('D2', depth=2, verbose=False,
...
AGENTS_CONFIG = [make_d1, make_d2, make_d1, make_d2]
AGENT_NAMES = ['D1', 'D2']
