# -*- coding: utf-8 -*-
"""Benchmark Baseline + defense against others."""
...
def make_baseline_defense():
    return ExpectiMaxBaselineAgent('BaseDef', verbose=False, defense_weight=2.0)
...
AGENTS_CONFIG = [
    make_baseline,
    make_baseline_defense,
    make_v2,
    make_v3,
]
AGENT_NAMES = ['Baseline', 'BaseDef', 'V2', 'V3']
...
def main():
    ...
    path = 'output/results_baseline_defense_{}.pkl'.format(n_games)
    with open(path, 'wb') as f:
        pickle.dump(results, f)
    print('Raw results saved to:', path)

    report_path = generate_report(results, AGENT_NAMES,
                                  output_path='output/baseline_defense_report.md')
