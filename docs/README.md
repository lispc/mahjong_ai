...
| [`plan-0718.md`](plan-0718.md) | **当前执行计划**：简化路径结论 + 2-ply 搜索目标 / 对手池多样性两项工程（预登记门）。 | 计划变更时 |
...
| [`reports/jax-rl-0717.md`](reports/jax-rl-0717.md) | **方向 1/1b（1b 晋升！）**：JAX 引擎 + KL 锚 PPO pilot（不晋升）→ Gumbel 搜索目标 AZ 闭环 12M 步 **+2.0% [+1.1,+2.9] @11000 pairs 晋升为新 best**；jaxenv 基础设施 |
